export default function Contact() {
  return (
    <section id="contact" className="py-24 px-6 max-w-5xl mx-auto border-t border-zinc-200">
      <p className="text-sm font-medium text-zinc-400 tracking-widest uppercase mb-3">
        Contact
      </p>
      <h2 className="font-serif text-4xl sm:text-5xl text-zinc-900 mb-6">
        Let&apos;s work together
      </h2>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        >
          <MailIcon />
          syazwanrazak1337@gmail.com
        </a>
        <a
          href="https://wa.me/60196353691"
          target="_blank"
